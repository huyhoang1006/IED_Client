...
app.on('ready', async () => {
    ...
    //circuit - Commented out - modules not found
    ...
    //Voltage Trans - Commented out - modules not found
    ...
    //Disconnecter - Commented out - modules not found
    ...
    // Surge Arrester - Commented out - modules not found
    ...
    // Power Cable - Commented out - modules not found
    ...
    //transformer - Commented out - modules not found
    // ipcTransformer.deleteAsset()

    // ipcJobTransformer.saveJobTransformer()
    // ipcJobTransformer.saveTestTransformer()

    //upload custom - Commented out - modules not found
    // ipcUploadCustom.active()

    //update manufacturer - Commented out - modules not found
