<template>
    <div class="logbar">
        <div class="option-bar">
            <div style="width: 50%; background-color: #012596;">
            </div>
            <div style="width: 50%; display: flex; align-items: center;">
                <input
                style="width: 50%; border: 1px solid #ccc; outline: none; height: 20px; box-sizing: border-box; background-color: white;"
                type="text"
                placeholder="Filter..."
                >
                <div style="width: 50%; height: 100%; box-sizing: border-box; display: flex; align-items: center; align-items: center; direction: rtl; gap: 10px;">
                    <i style="font-size: 15px; margin-right: 5px; color: white;" @click="hideLog" class="fa-solid fa-square-caret-down"></i>
                    <i style="font-size: 15px; color: white;" class="fa-solid fa-square-caret-up"></i>
                    <i :class="['fa-solid', 'fa-rotate-right', { spin: isLoadingReload }]" style="font-size: 15px; color: white;" @click="reloadLog"></i>
                </div>
            </div>
        </div>
...
.option-bar {
    ...
    display: flex;
    box-sizing: border-box;
    background-color: #012596; /* Đổi màu thành xanh đậm giống footer */
}
.table-content {
    width: 100%;
    ...
    position: relative;
    background-color: #012596; /* Đổi màu nền thành xanh đậm */
}
.log-body {
    width: 100%;
    height: calc(100% - 30px);
