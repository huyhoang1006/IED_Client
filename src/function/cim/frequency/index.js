...
// Lấy frequency theo mrids
export const getFrequencyByIds = async (mrids) => {
    return new Promise((resolve, reject) => {
...
// Cập nhật frequency theo mrid transaction
...
// Xóa frequency theo mrid transaction
