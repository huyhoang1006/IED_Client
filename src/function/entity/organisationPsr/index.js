...
export const insertOrganisationPsrTransaction = async (organisationPsr, dbsql) => {
    return new Promise((resolve, reject) => {
        // Normalize organisation_id - convert ROOT_ID to null for consistency
        const normalizeOrganisationId = (value) => {
        ...
        const normalizedOrganisationId = normalizeOrganisationId(organisationPsr.organisation_id);
